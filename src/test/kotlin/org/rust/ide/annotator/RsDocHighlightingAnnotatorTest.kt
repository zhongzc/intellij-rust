...
class RsDocHighlightingAnnotatorTest : RsAnnotatorTestBase(RsDocHighlightingAnnotator::class) {
    ...
    fun `test line doc`() = checkHighlighting1("""
    ...
    fun `test block doc`() = checkHighlighting1("""
        /*!
         *  <DOC_HEADING># Iterator</DOC_HEADING>
         *
         *  The heart and soul of this module is the <DOC_LINK>[`Iterator`]</DOC_LINK> trait. The core of
    ...
    fun `test doc heading`() = checkHighlighting1("""
    ...
    fun `test doc link`() = checkHighlighting1("""
    ...
    fun `test code span`() = checkHighlighting1("""
    ...
    fun `test code fence`() = checkHighlighting1("""
    ...
    fun `test header after code fence`() = checkHighlighting1("""
        /// <DOC_CODE>```</DOC_CODE>
    ...
    protected fun checkHighlighting1(@Language("Rust") text: String, ignoreExtraHighlighting: Boolean = false) =
